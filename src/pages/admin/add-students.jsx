...
import { UserRound, BookUser, Mail, UserRoundCog, Lock } from 'lucide-react';
    ...
    return (
        <>
            ...
            <div className="flex items-center mb-8">
                ...
                <input className="border-none border-b-2 border-gray-300 px-3 py-2 focus:outline-none bg-transparent w-full" type="text" placeholder="Name" />
            </div>
            <div className="flex items-center mb-8">
                <BookUser className="mr-2" size={30} style={{ strokeWidth: 1.7 }} />
                <input className="border-none border-b-2 border-gray-300 px-3 py-2 focus:outline-none bg-transparent w-full" type="text" placeholder="Roll Number" />
            </div>
            <div className="flex items-center mb-8">
                <Mail className="mr-2" size={30} style={{ strokeWidth: 1.7 }} />
                <input className="border-none border-b-2 border-gray-300 px-3 py-2 focus:outline-none bg-transparent w-full" type="text" placeholder="Web-mail" />
            </div>
            <div className="flex items-center mb-8">
            ...
            <div className="flex justify-end mb-8">
                <Button
                    className={`w-249 h-74 px-12 py-3 text-14 md:text-14 font-md mr-2 md:mr-4 border border-solid border-[#005DFF] bg-white rounded-md flex items-center gap-2 hover:bg-[#f9f9f9] hover:text-[#538ff8] hover:border-[#538ff8]`}
